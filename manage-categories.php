...
?>
    ...
    <head>
        ...
        <title>Manage Categories | Notes Management System</title>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit-category.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Edit</a> <a href="manage-categories.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                                                </td>
                                            </tr>
                                        <?php $cnt = $cnt + 1;
                                        } ?>
