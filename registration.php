    ...
    <head>
        ...
        <style>
            ...
            body {
                ...
                position: relative;
                overflow: hidden;
                background-color: transparent; /* overridden by gradient */
                color: #111;
            ...
            .login-card {
                ...
                width: 100%;
                max-width: 480px; /* Adjusted max-width for more form fields */
                color: #111;
                transition: background-color 0.3s ease, color 0.3s ease;
            }
            ...
            .login-card h3 { /* This h3 was replaced by the img tag */
                font-weight: 700;
                font-size: 2rem;
        ...
        <main class="d-flex align-items-center justify-content-center w-100 h-100">
            <div class="login-card shadow-lg">
                ...
                <form method="post" name="registration" onSubmit="return valid();">
                 ...
                 <div class="card-footer text-center py-3"> <div class="small"><a href="login.php">Have an account? Go to login</a></div>
                     <hr>
