...
<head>
    ...
    <title>Dashboard | Your App Name</title> <link href="https://cdn.jsdelivr.net/npm/simple-datatables@latest/dist/style.css" rel="stylesheet" />
    ...
    <style>
        body {
            ...
            transition: background-color 0.4s ease, color 0.4s ease; /* Fluid transition */
        }
        ...
        body.dark-mode .card {
            background-color: #2c2c2e !important; /* Darker card background */
            color: #f2f2f7 !important;
            border-color: #3a3a3c !important;
        }

        body.dark-mode .card-header {
            background-color: #3a3a3c !important; /* Darker header background */
            color: #f2f2f7 !important;
            border-color: #3a3a3c !important;
        }

        body.dark-mode .card-footer {
            background-color: #3a3a3c !important; /* Darker footer background */
            border-color: #3a3a3c !important;
        }

        body.dark-mode .text-white {
            color: #f2f2f7 !important; /* Ensure white text is visible in dark mode */
        }
        ...
        body.dark-mode .breadcrumb-item a {
            color: #bf5aff !important; /* Example link color in dark mode */
        }
        ...
        .card {
            ...
            transition: all 0.3s ease-in-out; /* Fluid transition for all changes */
        }
        ...
        .card.bg-primary {
         ...
         body.dark-mode .card.bg-primary {
            background-color: #0a84ff !important; /* Slightly different blue in dark mode */
            color: #ffffff !important;
         }

        .card.bg-success {
            background-color: #30d158 !important; /* Apple green */
            color: #ffffff !important;
        }

         body.dark-mode .card.bg-success {
            background-color: #32d74f !important; /* Slightly different green in dark mode */
            color: #ffffff !important;
         }
        ...
        #datatablesSimple {
            ...
            border: 1px solid #e0e0e0; /* Subtle border for table */
        }
        ...
        #datatablesSimple tbody tr {
            ...
            transition: background-color 0.2s ease; /* Fluid transition on hover */
        }
        ...
        body.dark-mode #datatablesSimple tbody tr:hover td {
            background-color: #3a3a3c; /* Dark mode hover effect */
        }
                ...
                <main>
                    <div class="container-fluid px-4">
                        <div class="dashboard-header-container">
                             <h1>Dashboard</h1>
                             <p class="dashboard-description">A quick overview of your categories and notes.</p> </div>
