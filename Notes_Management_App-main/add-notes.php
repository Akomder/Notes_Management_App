...
<html lang="en">
    <head>
        ...
        <title>Add Note | Notes Management System</title> <link href="https://cdn.jsdelivr.net/npm/simple-datatables@latest/dist/style.css" rel="stylesheet" />
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form  method="post" enctype="multipart/form-data">
                                    <div class="row mb-3"> <div class="col-md-2">Category Name</div> <div class="col-md-6">
                                    ...
                                    <div class="row mb-3"> <div class="col-md-2">Note Title</div> <div class="col-md-6"><input type="text" name="notetitle" placeholder="Enter the note title" class="form-control"></div>
                                    </div>
                                    <div class="row mb-3"> <div class="col-md-2">Note Description</div> <div class="col-md-6"><textarea  name="notediscription"  placeholder="Enter Note Description" rows="6" class="form-control"></textarea></div>
                                    </div>
                                    <div class="row mb-3"> <div class="col-md-2">Note Image</div> <div class="col-md-6"><input type="file" name="noteimage" accept="image/*" class="form-control"></div>
                                    </div>
                                    <div class="row"> <div class="col-md-2">&nbsp;</div> <div class="col-md-2"><button type="submit" name="submit" class="btn btn-primary">Submit</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
